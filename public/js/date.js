...
(function() {
    ...
    var $ = root.$ || root.jQuery || root.Zepto,
        ...
        SHORT_MONTHS = {}, SHORT_DAYS = {}, EXACT_DATE_TIME = {}, TZ_REGEXP = new RegExp('^[a-zA-Z]+/');
    ...
    timezoneJS.timezone = new function() {
        ...
        //Expose transport mechanism and allow overwrite.S
        this.transport = _transport;
        this.getTzInfo = function(dt, tz, isUTC) {
            //Lazy-load any zones not yet loaded.S
