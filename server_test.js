...
var mongojs = require('mongojs'),
    ...
    child, server = app.listen((!process.env.NODE_ENV || process.env.NODE_ENV == "production") ? 4000 : 40000),
...
var db = mongojs((!process.env.NODE_ENV || process.env.NODE_ENV == "production") ? "server" : "server_testing", ["swiches", "devices", "clients", "misc", "log", "deviceHis", "pir", "light", "temp", "bed", "sleep", "cpu", "switchHis", "history", "home_users"]);
